...
class sale_order_line(osv.osv):
    ...
    # [{'pricelist_id': (1, u'Public Pricelist (EUR)'), 'date_order': '2015-03-17 13:13:24', 'partner_id': (592, u'06bkqva38'), 'id': 99, 'fiscal_position': False}]
    def create(self, cr, uid, values, context=None):
        if values.get('order_id') and values.get('product_id') and  any(f not in values for f in ['name', 'price_unit', 'type', 'product_uom_qty', 'product_uom']):
            ...
            #We added this line because this code is not working for read method.  
