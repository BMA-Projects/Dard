...
workbook = xlrd.open_workbook('missing customer list 8-23-16_received from_client.xls')
...
while curr_row < num_rows:
    ...
    # print "country_id:L------",country_id
    # if customer_id:
    #     sock.execute(dbname, uid, pwd, 'res.partner', 'write', customer_id, {'country_id': country_id})
    if not customer_id:
