...
workbook = xlrd.open_workbook('Dard_Product_Data.xls')
...
while curr_row < num_rows:
    ...
    product_ids = sock.execute(dbname, uid, pwd, 'product.template', 'search', [('name', '=', row[0].value.strip().title()),('sale_ok','=',True),
                                                                                ('is_variant','=',True),('purchase_ok','=',False)])
